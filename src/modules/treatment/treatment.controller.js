...
export const createReport = asyncHandler(async (req, res, next) => {
    const report = await TreatmentReport.create(req.body);
...
export const getAllReports = asyncHandler(async (req, res, next) => {
    ...
    const total = await TreatmentReport.countDocuments();
...
export const filterReports = asyncHandler(async (req, res, next) => {
    ...
    const reports = await TreatmentReport.find(query).sort({ date: -1 });
...
export const getStats = asyncHandler(async (req, res, next) => {
    ...
    const totalReports = await TreatmentReport.countDocuments(query);
